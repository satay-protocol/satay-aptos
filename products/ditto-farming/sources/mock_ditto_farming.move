...
module satay_ditto_farming::mock_ditto_farming {
    ...
    public fun get_lp_reserves_amount() : u64 acquires FarmingAccountCapability {
        let ditto_strategy_cap = borrow_global<FarmingAccountCapability>(@satay_ditto_farming);
