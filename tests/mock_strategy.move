...
module satay::mock_strategy {
    ...
    fun get_strategy_aptos_balance(keeper_cap: &KeeperCapability<MockStrategy>): u64 {
        let wrapped_balance = base_strategy::harvest_balance<MockStrategy, WrappedAptos>(keeper_cap);
